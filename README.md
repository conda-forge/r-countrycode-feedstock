...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-countrycode-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-countrycode-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-countrycode
# for installing globally
pixi global install r-countrycode
```
...
It is possible to list all of the versions of `r-countrycode` available on your platform:
...
```
pixi search r-countrycode --channel conda-forge
```
